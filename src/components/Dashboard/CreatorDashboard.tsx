...
export default function CreatorDashboard({ isPreview }: CreatorDashboardProps) {
    ...
    return (
      <div className="w-full bg-neutral-50 p-6 rounded-sm">
        ...
        {userData?.services.map((service: any, index: number) => (
          <div
            key={index}
            className="bg-white p-6 flex flex-col rounded-md shadow-sm mb-4 relative"
          >
            <button
              onClick={() => {
            ...
            <div className="text-[16px] font-bold mb-2">{service.title}</div>
                  ...
                  <button
                    onClick={() => {
                      handleUserData(
                        "previousWork",
                        "delete",
                        userData?.previousWork[index]._id,
                        {}
                      );
                    }}
  ...
  const WorkDiv = () => {
    return (
      <div className="w-full bg-neutral-50 p-6 rounded-sm">
        <h2 className="uppercase mb-4">Feautered Work</h2>
                  ...
                  <button
                    onClick={() => {
                      handleUserData(
                        "featuredWork",
                        "delete",
                        userData?.featuredWork[index]._id,
                        {}
                      );
                    }}
                    className="text-white text-3xl cursor-pointer"
            ...
            <div className="relative">
              <div className="relative w-full h-48 sm:h-72 group">
                ...
                <input
                  ...
                  onChange={(event) =>
                    handleUserFilesChange(event, "coverImage")
                  }
                />
              </div>

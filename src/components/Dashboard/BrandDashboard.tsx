                ...
                <div className="mt-6">
                    <div className="flex justify-between items-center">
                        ...
                        <Button
                            ...
                            variant="outline" size="small" className="flex items-center space-x-2 max-w-[20%]">
                            <Plus />
                            Add Product
                        </Button>
                    </div>
            ...
            >
                <div className="flex space-x-6">
                    <div className="w-1/2 space-y-4">
                        <div>
                            <label className="block text-sm font-medium text-gray-700" htmlFor="targetAudience">
                                Target Audience
                            </label>
                            <Input
                                id="targetAudience"
                    ...
                    <div className="w-1/2 space-y-4">
                        <div>
                            <label className="block text-sm font-medium text-gray-700">Ongoing Campaign</label>
                            <Switch

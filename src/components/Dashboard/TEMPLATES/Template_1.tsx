...
const Template_1: React.FC<Template1Props> = ({
    ...
    return (
        <div
            key={index}
            id={`post-${index}`}
            className="bg-[#1E220E] w-full h-full flex flex-col justify-between p-12 relative"
        >
            {/* Gradient images with z-index 0 */}
            {index === 0 ? (
                <img
                    src="/templates/template_1_gradient.png"
                    alt="gradient"
                    className="absolute right-0 w-1/2 z-0"
                />
            ) : (
                <>
                    <img
            ...
            <div className={`mt-24 z-10 relative ${index === 0 ? "text-left" : "text-center"}`}>
                ...
                < div className="flex items-center space-x-4" >
                    ...
                    <div>
                        ...
                        <p
                            ...
                            className="text-sm text-neutral-300 text-left">{editableProfileUsername}</p>
                    </div>

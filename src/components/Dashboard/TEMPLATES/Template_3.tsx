...
const Template_3: React.FC<Template1Props> = ({
    index,
    isLastItem = false,
}) => {
    ...
    return (
        <div
            key={index}
            id={`post-${index}`}
            className="bg-[#BF8A5B] w-full h-full flex flex-col justify-between p-12 relative"
        >
            {/* Gradient images with z-index 0 */}
            <img src="/templates/template_3_pattern.svg" alt=""

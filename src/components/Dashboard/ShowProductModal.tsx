...
export default function ShowProductModal({
  ...
  return (
    ...
    >
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="text-sm text-gray-700 space-y-2">
          {product.additionalDetails && (
            <p className="whitespace-pre-wrap">{product.additionalDetails}</p>
          )}
          <p>
          ...
          <div className="space-y-2 mt-3">
            ...
            {product.g2Link && (
              ...
              >
                <img src="/images/g2.jpeg" alt="G2 Logo" className="w-8 mr-2" />
      ...
      {product.loomVideoLink &&
        product.loomVideoLink !== "" &&
        product.loomVideoLink !== "null" &&
        product?.loomVideoLink?.includes("/share/") && (
          <>
            <Divider className="mt-6" />
            <h4 className="text-lg font-medium text-neutral-800 mb-3">
              Demo Video
